...
#. | **Day 0** - железка только появилась в наших руках. Сейчас самое важное - базовая настройка:
    ...
    * Добавить IP-адрес управления и маршрут</li>
    * Включить SSH</li>
    * Создать пользователя с правами настройки</li>
...
* Формализованный дизайн
* Версионирование
* Транзакционность, а если быть точнее, то соответствие требованиям ACID">ACID
